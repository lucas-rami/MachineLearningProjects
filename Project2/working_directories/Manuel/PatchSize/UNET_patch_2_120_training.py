...
from modelUNET_2_120 import get_unet_2_120,f1_score
...
model = get_unet_2_120(input_img, n_filters=16, dropout=0.2, batchnorm=True)

model.compile(optimizer=Adam(), loss="binary_crossentropy", metrics=[f1_score])
model.summary()

checkpointName = 'UNET_patch_2_120'
