...
def get_unet_180(input_img, num_classes = 2, n_filters=16, dropout=0.2, batchnorm=False):
    # contracting path
    ...
    u7 = Conv2DTranspose(n_filters*4, (3, 3),activation='selu', strides=(9, 9), padding='same') (c6)
