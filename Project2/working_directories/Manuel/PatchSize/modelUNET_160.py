...
def get_unet_160(input_img, num_classes = 2, n_filters=16, dropout=0.2, batchnorm=False):
    # contracting path
    ...
    u7 = Conv2DTranspose(n_filters*4, (3, 3),activation='selu', strides=(8, 8), padding='same') (c6)
