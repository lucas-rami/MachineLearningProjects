...
def get_unet_80_bl(input_img, num_classes = 2, n_filters=16, dropout=0.2, batchnorm=False):
    # contracting path
    ...
    # expansive path
    u6 = Conv2DTranspose(n_filters*8, (3, 3),activation='selu', strides=(2, 2), padding='same') (c5)
    u6 = concatenate([u6, c4])
    c6 = conv2d_block(u6, n_filters=n_filters*8, kernel_size=3,dropout=dropout, batchnorm=batchnorm)

    u7 = Conv2DTranspose(n_filters*4, (3, 3),activation='selu', strides=(2, 2), padding='same') (c6)
