...
callbacks = [EarlyStopping(patience=15, verbose=1),ReduceLROnPlateau(factor=0.1, patience=5, min_lr=0.00001, verbose=1),ModelCheckpoint('test_CNN_200_rot.h5', verbose=1, save_best_only=True, save_weights_only=True)]
