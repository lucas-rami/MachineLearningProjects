...
callbacks = [EarlyStopping(patience=10, verbose=1),ReduceLROnPlateau(factor=0.1, patience=3, min_lr=0.00001, verbose=1),ModelCheckpoint('test_FCN_200.h5', verbose=1, save_best_only=True, save_weights_only=True)]
...
model.load_weights('test_FCN_200.h5')
