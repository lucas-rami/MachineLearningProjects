...
np.savetxt('ratio.out', (ratio, ratio_scores))

print("Best score: " + str(round(best_overall_score,4)) + ", with best ratio: " + str(round(best_ratio,2)) +", and best threshold: " + str(round(best_overall_thr,2)))
best_overall_thr = 0.3
